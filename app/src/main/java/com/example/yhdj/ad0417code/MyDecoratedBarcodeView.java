...
public class MyDecoratedBarcodeView extends FrameLayout {
     ...
     */
    private com.journeyapps.barcodescanner.DecoratedBarcodeView.TorchListener torchListener;
    ...
    private void initialize(AttributeSet attrs) {
        ...
        int scannerLayout = attributes.getResourceId(
                com.google.zxing.client.android.R.styleable.zxing_view_zxing_scanner_layout, R.layout.my_barcode_scanner);

        attributes.recycle();

        inflate(getContext(), scannerLayout, this);

        barcodeView = (BarcodeView) findViewById(R.id.my_barcode_surface);
     ...
     //   barcodeView.initializeAttributes(attrs);
        ...
        viewFinder = (ViewfinderView) findViewById(R.id.my_viewfinder_view);
        ...
        statusView = (TextView) findViewById(R.id.my_status_view);
    }
    ...
    public BarcodeView getBarcodeView() {
        return (BarcodeView) findViewById(R.id.my_barcode_surface);
    }
    ...
    public void decodeSingle(BarcodeCallback callback) {
        barcodeView.decodeSingle(new MyDecoratedBarcodeView.WrappedCallback(callback));
    ...
    public void decodeContinuous(BarcodeCallback callback) {
        barcodeView.decodeContinuous(new MyDecoratedBarcodeView.WrappedCallback(callback));
    }
    ...
    public void setTorchListener(com.journeyapps.barcodescanner.DecoratedBarcodeView.TorchListener listener) {
